...
namespace enertect.Core.ViewModels.Base
{
    public abstract class BaseWithObjectAndReturnViewModel<TParam, TReturn> : MvxViewModel<TParam, TReturn>
    {
        ...
        public BaseWithObjectAndReturnViewModel(IMvxNavigationService navigationService, IDialogService dialogService)
        {
